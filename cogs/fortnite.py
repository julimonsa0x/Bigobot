...
class Fortnite(commands.Cog):
    ...
    async def fortnitestats(self, ctx, *usuario):
        ...
        if fortnite_response['status'] == 200:
            # Images
            fortnite_template_image = Image.open(r'.\images\fortnite_template.png')

            # Fonts
            username_font = ImageFont.truetype(r'fonts\theboldfont.ttf', 50)
            stats_font = ImageFont.truetype(r'fonts\theboldfont.ttf', 40)
