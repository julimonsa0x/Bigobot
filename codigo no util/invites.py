# actually this cog is not working...
"""
...
async def on_ready(self):
	print("cog de invitaciones listo")
...
@Cog.listener()
async def on_guild_join(self, guild): # add new invites to monitor
...
@Cog.listener()
async def on_guild_remove(self, guild): # remove all instances of the given guild_id
